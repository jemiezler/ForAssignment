...
public class ConcertController {
    ...
    @GetMapping("/book")//TODO: add proper annotation for GET method
    ...
    @GetMapping("/book/concerts/{concertId}")//TODO: add proper annotation for GET method
    ...
    @Transactional
    @PostMapping("/book/concerts/{concertId}")//TODO: add proper annotation for POST method
    public String reserveSeat(@ModelAttribute Reservation reservation, @PathVariable Long concertId, Model model) {
        ...
        Seat seat = seatRepo.findById(reservation.getSeat().getId()).orElse(null);
        if (seat == null) {
